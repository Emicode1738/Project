# 🚀 Project (Blueberry Browser Extension)

### 📝 About
The **Blueberry Browser Extension** is a Tab Management tool that allows users to save, organize, and revisit browser tabs using a timer-based reminder system. It is designed to improve productivity and reduce browser clutter by helping you manage your active tabs more effectively.

---

### 📥 Download Link
[**Click here to download the Project files (.zip)**](https://github.com/Emicode1738/Project/archive/refs/heads/main.zip)
